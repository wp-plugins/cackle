...
<rss version="2.0"
    ...
    <channel>
        ...
        <generator>WordPress <?php bloginfo_rss('version'); ?>; C <?php echo CACKLE_VERSION; ?></generator>
        <?php
        ...
        <item>
            ...
            <dc:creator><?php echo cackle_export_wxr_cdata(get_the_author()); ?></dc:creator>
            <guid isPermaLink="false"><?php the_guid(); ?></guid>
            <content:encoded><?php echo cackle_export_wxr_cdata(apply_filters('the_content_export', $post->post_content)); ?></content:encoded>
            <cackle:thread_identifier><?php echo cackle_identifier_for_post($post); ?></cackle:thread_identifier>
            ...
            if ($comments) {
                foreach ($comments as $c) {
                    ...
                    <wp:comment>
                        ...
                        <wp:comment_author><?php echo cackle_export_wxr_cdata($c->comment_author); ?></wp:comment_author>
                        <wp:comment_author_email><?php echo $c->comment_author_email; ?></wp:comment_author_email>
                        <wp:comment_author_url><?php echo $c->comment_author_url; ?></wp:comment_author_url>
                        <wp:comment_author_IP><?php echo $c->comment_author_IP; ?></wp:comment_author_IP>
                        <wp:comment_date><?php echo $c->comment_date; ?></wp:comment_date>
                        <wp:comment_date_gmt><?php echo $c->comment_date_gmt; ?></wp:comment_date_gmt>
                        <wp:comment_content><?php echo cackle_export_wxr_cdata($c->comment_content) ?></wp:comment_content>
